...
public class LevelManager {
    ...
    public static void init() {
        ...
        levelLists.add(new LevelData("f6 L12233 L22637 L36273 L46677 l5 l9 l13 l17", "Blocs verrouillés"));
        levelLists.add(new LevelData("f5", "5 fruits"));
        ...
        levelLists.add(new LevelData("f512", "5 fruits dont 2 forcés"));
        levelLists.add(new LevelData("f4 F0099", "4 fruits"));
        levelLists.add(new LevelData("f8", "8 fruits"));
